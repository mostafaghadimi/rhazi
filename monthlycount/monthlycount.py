...
for index, row in questions_data_frame.iterrows():
    ...
    if row['expertise_id']:
        monthly_data_frame.loc[row['created'][:7], row["expertise_id"]] += 1
